'use strict';
/* ohn wants to decorate a room with wallpaper. He wants a fool-proof method for getting it right.
...
//   } else {
//     const roll = 10 * 0.52;
//     const room = l * h * 2 + w * h * 2;
//     const res = Math.ceil((room / roll) * 1.15);

//     const totalRolls = numbers[res];
//     return totalRolls;
//   }
// }
...
// console.log(wallpaper(0, 5.8, 3.13)); //, 'seventeen');
